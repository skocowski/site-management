...
const PermitTemplate: FC<permitTemplateProps> = ({ permit }) => {
    return (
                ...
                <div className="space-y-10">
                    ...
                    <div className="space-y-3 pt-10">
                        ...
                        <div className="flex flex-col sm:flex-row sm:gap-5 gap-1 items-start sm:items-center">
                            ...
                            <div className="text-sm text-muted-foreground">    {permit.location}</div>
                        </div>

                        <div className="flex flex-col sm:flex-row sm:gap-5 gap-1 items-start sm:items-center">
                            <div className="font-semibold flex-none sm:w-24 w-full">Equipment</div>
                            <div className="text-sm text-muted-foreground">{permit.equipment}</div>
                        </div>

                        <div className="flex flex-col sm:flex-row sm:gap-5 gap-1 items-start sm:items-center">
                            <div className="font-semibold flex-none sm:w-24 w-full">Date</div>
                            <div className="flex flex-col sm:flex-row gap-1 sm:gap-5">
                                <div className="text-sm text-muted-foreground">Start: {permit.startDate}</div>
                                <div className="text-sm text-muted-foreground">End: {permit.endDate}</div>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:gap-5 gap-1 items-start sm:items-center">
                            ...
                            <div className="text-sm text-muted-foreground">{permit.rams}</div>
                        </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex flex-col gap-1 items-start ">
                            ...
                            <div className="text-sm text-muted-foreground">   {permit.pointsOfIsolation}</div>
                        </div>

                        <div className="flex flex-col gap-1 items-start ">
                            <div className="font-semibold flex-none w-full">Primary earth device(s)</div>
                            <div className="text-sm text-muted-foreground">  {permit.primaryEarthingDevice}</div>
                        </div>
                        ...
                        <div className="flex flex-col gap-1 items-start ">
                            ...
                            <div className="text-sm text-muted-foreground">{permit.actionsTaken}</div>
                        </div>
                        ...
                        <div className="flex flex-col gap-1 items-start ">
                            ...
                            <div className="text-sm text-muted-foreground">{permit.furtherPrecautions}</div>
                        </div>

                        <div className="flex flex-col gap-1 items-start ">
                            <div className="font-semibold flex-none w-full">Precautions which may be varried (approved procedure required)</div>
                            <div className="text-sm text-muted-foreground">  {permit.variedPrecautions}</div>
                        </div>
