...
export const buttonTheme: CustomFlowbiteTheme["button"] = {
  ...
  color: {
    ...
    lightYellow:
      "text-gray-900 bg-yellow-300 border border-transparent enabled:hover:bg-yellow-400 focus:ring-4 focus:ring-yellow-200 dark:focus:ring-yellow-900",
  },
  ...
  inner: {
    ...
    outline: "border border-transparent bg-yellow-300",
    isProcessingPadding: {
      xs: "pl-8",
      sm: "pl-10",
      md: "pl-12",
  ...
  size: {
    ...
    export const dropdownTheme: CustomFlowbiteTheme["dropdown"] = {
      ...
      content: "py-1 focus:outline-non ",
      floating: {
        ...
        style: {
          ...
          auto: "border border-gray-200 bg-yellow-300 text-gray-900 ",
        },
        target: "w-fit bg-yellow-300 hover:bg-yellow-300 focus:bg-yellow-300 ",
      },
      inlineWrapper:
        "flex items-center hover:bg-yellow-300 focus:bg-yellow-300 hover:rounded-lg focus:rounded-lg",
    };

    export     const progressTheme: CustomFlowbiteTheme["progress"] = {
      base: "w-full overflow-hidden bg-gray-700",
      label: " flex justify-between font-medium dark:text-white",
      bar: "text-end font-medium leading-none text-white space-x-2",
      color: {
    ...
    export      const footerTheme: CustomFlowbiteTheme["footer"] = {
      root: {
        base: "w-full rounded-lg bg-primary shadow  md:flex md:items-center md:justify-between",
        container: "w-full p-6",
        bgDark: "bg-gray-800",
      },
      groupLink: {
        base: "flex flex-wrap text-sm text-mainText dark:text-white",
        link: {
      ...
      icon: {
        base: "text-mainText dark:hover:text-white",
        size: "h-5 w-5",
      },
      title: {
        base: "mb-6 text-sm font-semibold uppercase text-mainText ",
      },
      divider: {
        base: "w-full my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8",
      },
      copyright: {
        base: "text-sm text-mainText  sm:text-center",
      ...
      brand: {
        ...
        img: "mr-3 h-8",
        span: "self-center whitespace-nowrap text-2xl font-semibold text-mainText dark:text-white",
      },
}; 
